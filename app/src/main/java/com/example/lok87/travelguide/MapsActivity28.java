...
public class MapsActivity28 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps28);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng colombia = new LatLng(-1, -70);
