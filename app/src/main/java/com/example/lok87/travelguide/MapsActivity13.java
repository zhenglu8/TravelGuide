...
public class MapsActivity13 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps13);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Bangkok = new LatLng(13, 100);
